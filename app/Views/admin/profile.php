...
?>
<main class="container-fluid g-4">
    <div class="row">
        <!-- Sidebar -->
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data"
                                    action="/Agencedevoyage/profile-submit" autocomplete="off">
                                    <div class="mb-3">
                                    ...
                                    <button type="submit" class="btn btn-info text-white">Enregistrer les
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/Agencedevoyage/profile-submit">
                                    ...
                                    <div class="mb-3">
                                        <label for="new_password" class="form-label">Nouveau mot de passe (4-8
                                            caractères)</label>
